...
|---------|-----------|---------|
| Default (hermes) | `~/.hermes/google_token.json` | jared.zimmerman@gmail.com + work + family |
...
|---|---|---|---|
| `jared.zimmerman@gmail.com` | Personal | writer | Primary personal calendar |
...
| ~~`jared.zimmerman@innovaccer.com`~~ | ~~Work~~ | ~~404~~ | **Inaccessible** — returns Not Found |

**Note:** The work calendar `jared.zimmerman@innovaccer.com` was accessible in earlier runs (events.jsonl has entries) but now returns 404. Do not hardcode calendar IDs — always discover via `calendarList().list()`.
